...
<div class="footer_menu_div">
	<fieldset class="greenfieldset">
		<table>
			<tbody>
				<tr>
					<td id="view_cart"><span id="cartItem_count"><%=items.size() %> </span> <a href="viewcart.jsp">View Cart</a></td>
					<td>
...
//on Search Tools Form Submit event
$('submit').observe('click',searchresult);
//Event.observe('submit', 'click', searchresult, false); 
